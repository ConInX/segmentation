...
def main():
    ...
    val_dataloader = torch.utils.data.DataLoader(DARBuDDataset(args.dataset + "/val/", train_transform), batch_size=args.batch_size, shuffle=False, drop_last=False)
    test_dataloader = torch.utils.data.DataLoader(DARBuDDataset(args.dataset + "/test/", train_transform), batch_size=args.batch_size, shuffle=False, drop_last=False)
    # init model
